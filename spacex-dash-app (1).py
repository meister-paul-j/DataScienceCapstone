...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        site_outcomes.columns = ['outcome','count']
        site_outcomes['outcome'] = site_outcomes['outcome'].map({1: 'Success', 0: 'Failure'})
        fig = px.pie(site_outcomes, values='count', names='outcome', title=f'Launches for {entered_site}')
        return fig
# TASK 4:
